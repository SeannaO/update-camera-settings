...
//
// 			exec('cp ' + __dirname+'/fixtures/files/chunk_1.ts' + ' ' + recordModel.folder + '/videos/tmp/chunk_1.ts');
//
// 			var time = Math.round( Math.random() * Date.now() );
//
// 			var video = {
...
//
// 			console.error('==== toFolder: ' + toFolder);
// 			console.error('==== destination: ' + destination_file);
// 			console.error('==== from: ' + video.file);
//
// 			recordModel.moveFile( video, function(err) {
// 				setTimeout( function() {
// 					fs.exists( destination_file, function(exists) {
